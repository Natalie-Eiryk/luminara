...
const CACHE_NAME = 'luminara-quiz-v137';
...
const OPTIONAL_ASSETS = [
  ...
  './lab-exam-ii/module.v2.json',
  './lab-exam-ii/v2-bridge.js',
  './lab-exam-ii/diagnostics.html',
  './lab-exam-ii/diagnostics.js',
  ...
  './820.31-v2/teaching-module-v2.js',
  './820.31-v2/schemas/teaching-module-manifest.schema.json',
  './820.31-v2/schemas/learning-item.schema.json',
  './820.31-v2/schemas/learner-progress-record.schema.json',
  './820.31-v2/schemas/lumi-teaching-signal.schema.json',
  './820.31-v2/schemas/teaching-diagnostics.schema.json',
